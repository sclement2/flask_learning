...
- 🎯 Entry points to execute your program using `python -m <flask_learning>` or `$ flask_learning` with basic CLI argument parsing.
...
---
# flask_learning Flask Application

Awesome flask_learning created by sclement2
...
```bash
git clone https://github.com/sclement2/flask_learning flask_learning
cd flask_learning
make install
```
...
```bash
flask_learning create-db   # run once
flask_learning populate-db  # run once (optional)
flask_learning add-user -u admin -p 1234  # ads a user
flask_learning run
```
